...
export class AScene extends Phaser.Scene {
     ...
     */
    fadeOutAndStartScene(scene, data) {
...
export class GameMap extends AScene {
    ...
    /**
    * Create the spritesheet animations of the player or the chaser.
    *
    * Only loads one of chaser or player because HoldingAreaScene can't
    * create animations with a spritesheet that hasn't been loaded, causing
